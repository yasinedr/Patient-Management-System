                           ...
                           <div class="p-5">
                              <div class="text-center">
                                <!--  <img src="<?php echo e(asset('img/logo-grey.png')); ?>" class="img-fluid" > -->
                                 <img src="<?php echo e(asset('img/profile.jpg')); ?>" class="img-fluid" class="profile-admin" style="border-radius: 50%;max-width: 200px;" >
                                 <div class="admin-refer" style=" margin: 20px;">
                                    <a href="https://dev.ilyasine.com" target="_blank" rel="noopener noreferrer">Yassine Idrissi</a>
                                 </div>
...
<?php /**PATH /home/yasine/dev/doctor/resources/views/auth/login.blade.php ENDPATH**/ ?>