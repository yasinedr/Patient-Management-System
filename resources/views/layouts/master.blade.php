            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseSettings" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('doctorino_settings.edit') }}">{{ __('sentence.System Settings') }}</a>
               ...
               <footer class="sticky-footer bg-white">
                  <div class="container my-auto">
                     <div class="copyright my-auto">
                        <span>Copyright &copy; Developed by <a href="https://dev.ilyasine.com" target="_blank"> Yassine Idrissi</a> {{ date('Y') }}</span>
                        <span style="float: right;">Development mode</span>
                     </div>
                  </div>
               </footer>
               <!-- End of Footer -->
